...
- [Cloudflare Optimization Solutions](https://github.com/wusansan2015/v2ray-agent/blob/master/documents/optimize_V2Ray.md)
- [Traffic Transit Tutorial](https://github.com/wusansan2015/v2ray-agent/blob/master/documents/traffic_relay.md)
- [SSH Getting Started Tutorial](https://g.com/2020-12-16-ssh%E5%85%A5%E9%97%A8%E6%95%99%E7%A8%8B)
- [TG Group](https://t.me/technologyshare)、[TG Channel](https://t.me/v2rayagentshare)、[Blog](https://g.com/)
...
- [Cloudflare Introductory tutorial](https://github.com/wusansan2015/v2ray-agent/blob/master/documents/cloudflare_init.md)
...
- Support IPv6，[IPv6 Notes](https://github.com/wusansan2015/v2ray-agent/blob/master/documents/IPv6_help.md)
...
- [Support custom certificate installation](https://github.com/wusansan2015/v2ray-agent/blob/master/documents/install_tls.md)
...
- wget: command not found [**Here you need to manually install the wget yourself**]
  ，If you have not used Linux，[Click to view](https://github.com/wusansan2015/v2ray-agent/tree/master/documents/install_tools.md)Installation Tutorial
...
## [Scripting Common Commands](https://github.com/wusansan2015/v2ray-agent/blob/master/documents/common_commands.md)

## [Common script errors handling](https://github.com/wusansan2015/v2ray-agent/blob/master/documents/shell_error.md)
...
```
wget -P /root -N --no-check-certificate "https://raw.githubusercontent.com/wusansan2015/v2ray-agent/9ae23c13a56460d8c14f27c8eb65efc73b173f46/install.sh" && chmod 700 /root/install.sh && /root/install.sh
```

- Stable-v2.1.27

```
wget -P /root -N --no-check-certificate "https://raw.githubusercontent.com/wusansan2015/v2ray-agent/3f8ea0aa364ae2e1e407056074c11b448396261f/install.sh" && chmod 700 /root/install.sh && /root/install.sh
```
